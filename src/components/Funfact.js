                            ...
                            <div className="fun_fact_content">
                                ...
                                <div className="d-flex">
                                    <div className="fact_item">
                                        <h1 className={`${tClass}`}><span>{CnumberOne}</span>More</h1>
                                        <p className="mb-0">Companies trust <br/>our AMASHR System</p>
                                    </div>
                                    <div className="fact_item pl_100">
                                        <h1 className={`${tClass}`}><span>{CnumberTwo}</span>Clients</h1>
