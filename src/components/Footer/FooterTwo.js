                                    ...
                                    return(
                                        <Reveal effect="fadeInUp" key={widget.id}>
                                            <div className="col-lg-3 col-md-6">
                                                ...
                                                <a href="index.html" className="f-logo"><img src={require('../../img/amasB.png')} alt=""/></a>
                                                    <div className="widget-wrap">
                                                        <p className="f_400 f_p f_size_15 mb-0 l_height34"><span>Email:</span> <a href="mailto:info@amashr.com" className="f_400">info@amashr.com</a></p>
                                                        <p className="f_400 f_p f_size_15 mb-0 l_height34"><span>Phone:</span> <a href="tel:+255745272829" className="f_400">+255 745 272 829</a></p>
                                                    </div>
