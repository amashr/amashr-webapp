                ...
                <div className="row">
                    ...
                    <div className="col-lg-5 offset-lg-1 d-flex align-items-center">
                        ...
                        <div className="agency_content_two">
                            <h2 className="f_700 f_size_40 l_height50 w_color mb_20">Don't worry about managing HR, Benefits,and Payroll</h2>
                            <p className="f_400 w_color l_height28">AMAS HR is here for you. Just focus on your core business</p>
