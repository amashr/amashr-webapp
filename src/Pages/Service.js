...
const Service = () => {
    return(
        <div className="body_wrapper">
            ...
            <Breadcrumb breadcrumbClass="breadcrumb_area" imgName="breadcrumb/banner_bg.png" Ptitle="Our Software" Pdescription=" It’s designed to set you free to focus on what matters most—your people."/>
